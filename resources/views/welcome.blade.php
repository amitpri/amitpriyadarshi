        ...
        <div class="body">
            ...
            <header id="header" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 122, 'stickySetTop': '-122px', 'stickyChangeLogo': false}">
                <div class="header-body border-color-primary border-top-0 box-shadow-none">
                                        ...
                                        <nav class="header-nav-top">
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
                                                    <span class="ws-nowrap"><i class="fas fa-phone"></i> (+91) 9538988111</span>
                                                </li>
                                            </ul>
                                        </nav>
                                    </div>
                    ...
                    <div class="header-container container z-index-2" style="min-height: 52px;">
                        <div class="header-row">
                                    ...
                                    <a href="/show?id={{ $blog_top->id}}&name={{ $blog_top->name}}">
                                        <article class="thumb-info thumb-info-no-borders thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
                                            <div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
                                                <img src="/storage/{{$blog_top->image1}}" class="img-fluid" alt="How To Take Better Concert Pictures in 30 Seconds">
                                                <div class="thumb-info-title bg-transparent p-4">
                                                    <div class="thumb-info-type bg-color-dark px-2 mb-1">{{$blog_top->category_name}}</div>
                                                    <div class="thumb-info-inner mt-1">
                                                        <h2 class="font-weight-bold text-color-light line-height-2 text-5 mb-0">{{$blog_top->name}}</h2>
                                                    </div>
                                                    <div class="thumb-info-show-more-content">
                                                        <p class="mb-0 text-1 line-height-9 mb-1 mt-2 text-light opacity-5">{{$blog_top->summary}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
                                            ...
                                            <div class="col-sm-7 pl-sm-1">
                                                <div class="thumb-info-caption-text">
                                                    <div class="thumb-info-type text-light text-uppercase d-inline-block bg-color-dark px-2 m-0 mb-1 float-none">
                                                        <a href="/c/{{ $blog->category_id}}" class="text-decoration-none text-color-light">{{ $blog->category_name}}</a>
                                                    </div>
                                                    <h2 class="d-block line-height-2 text-4 text-dark font-weight-bold mt-1 mb-0">
                                                        <a href="/show?id={{ $blog->id}}&name={{ $blog->name}}" class="text-decoration-none text-color-dark">{{ $blog->name}}</a>
                                                    </h2>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4 pb-1">
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$bigdata_blog_top->image1}}" class="img-fluid border-radius-0" alt="Why should I buy a smartwatch?">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        @if (($bigdata_blog->top3) === 0)
                                            ...
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-4 mb-2">
                                                <div class="row align-items-center pb-1">
                                                    <div class="col-sm-4">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$bigdata_blog->image1}}" class="img-fluid border-radius-0" alt="Gadgets That Make Your Smartphone Even Smarter">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 mb-4 pb-1">
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$cloud_blog_top->image1}}" class="img-fluid border-radius-0" alt="Why should I buy a smartwatch?">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        @if (($cloud_blog->top3) === 0)
                                            ...
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-4 mb-2">
                                                <div class="row align-items-center pb-1">
                                                    <div class="col-sm-4">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$cloud_blog->image1}}" class="img-fluid border-radius-0" alt="Gadgets That Make Your Smartphone Even Smarter">
                                                        </a>
                                                    </div>
                                                    <div class="col-sm-8 pl-sm-0">
                                                        <div class="thumb-info-caption-text">
                                        ...
                                        <div class="col-lg-6 mb-4 pb-1">
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$dwh_blog_top->image1}}" class="img-fluid border-radius-0" alt="Why should I buy a smartwatch?">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        @if (($dwh_blog->top3) === 0)
                                            ...
                                            <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-4 mb-2">
                                                <div class="row align-items-center pb-1">
                                                    <div class="col-sm-4">
                                                        <a href="blog-post.html">
                                                            <img src="/storage/{{$dwh_blog->image1}}" class="img-fluid border-radius-0" alt="Gadgets That Make Your Smartphone Even Smarter">
                                                        </a>
                                                    </div>
                                                    <div class="col-sm-8 pl-sm-0">
                                                        <div class="thumb-info-caption-text">
                                                ...
                                                <article>
                                                    <div class="post-image">
                                                        <div class="img-thumbnail img-thumbnail-no-borders d-block">
                                                            <a href="blog-post.html">
                                                                <img src="/storage/{{$blog_popular->image1}}" class="border-radius-0" width="50" height="50" alt="Simple Ways to Have a Pretty Face">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post-info">
                                    ...
                                    <div class="mb-4 pb-2">
                                        <article class="thumb-info thumb-info-side-image thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                            <div class="row">
                                                <div class="col">
                                                    <a href="blog-post.html">
                                                        <img src="/storage/{{$blog_featured->image1}}" class="img-fluid border-radius-0" alt="Main Reasons To Stop Texting And Driving">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="row py-5 my-4">
                        <div class="col-md-6 col-lg-10 mb-5 mb-lg-0">
                            ...
                            <p class="mb-0"><a href="/about" class="btn-flat btn-xs text-color-light p-relative top-5"><strong class="text-2">VIEW MORE</strong><i class="fas fa-angle-right p-relative top-1 pl-2"></i></a></p>
                        </div>
    
                        <div class="col-md-6 col-lg-2">
                            <h5 class="text-3 mb-3">Topics</h5>
                            <p>
